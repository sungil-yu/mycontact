...
class PersonServiceTest {
    ...
    void delete(){
        ...
        verify(personRepository, times(1)).save(argThat(new IsPersonNameWiilBedeleted()));
    }
    ...
    void modifyByName(){
        ...
        verify(personRepository, times(1)).save(argThat(new IsPersonNameWiilBeUpdated()));
    }
    ...
    private static class IsPersonNameWiilBeUpdated implements  ArgumentMatcher<Person>{
    ...
    private static class IsPersonNameWiilBedeleted implements  ArgumentMatcher<Person>{
